...
void autonomous(void) 
{
  ...
  driveSystem.turnOnlyRightBack(18.5, 120);
  ...
  driveSystem.driveDistance(100, 108); //Drive a smidge forward
  driveSystem.turnDegrees(22.75, 180); //turn a little more
  rIntake.spin(forward, intakeSpeed, dps);
  lIntake.spin(forward, intakeSpeed, dps);
  driveSystem.driveDistance(1150, 540); //drive slightly past the original position of the ball to ensure it gets the ball.
  driveSystem.turnDegrees(-35, 180);//face tower
  driveSystem.driveDistance(770, 540, 4); //drive to tower
  ...
  driveSystem.driveDistance(-450, 270);
  rIntake.stop();
  lIntake.stop();

  //turn toward the next ball (3rd tower)
  driveSystem.turnDegrees(86.5, 270);
  ...
  rIntake.spin(forward, intakeSpeed, dps);
  lIntake.spin(forward, intakeSpeed, dps);
  driveSystem.driveDistance(1725, 540, 7);
  conveyL.stop();
  conveyR.stop();
  vex::task::sleep(100);
  ...
  driveSystem.turnDegrees(0, 216);
  driveSystem.driveDistance(255, 432, 2);
  rIntake.stop();
  lIntake.stop();
  ...
  lIntake.spin(forward, -intakeSpeed/2, dps);
  driveSystem.driveDistance(-255, -720); //drive back the same amount you went in.
  rIntake.stop();
  lIntake.stop();

  //get the next ball. (4th tower)
  driveSystem.turnDegrees(90.5, 540); //face 90
  rIntake.spin(forward, intakeSpeed, dps); //intake
  lIntake.spin(forward, intakeSpeed, dps);
  driveSystem.driveDistance(1600, 600); //get ball
