...
void autonomous(void) 
{
  ...
  vex::task::sleep(1500);
  lIntake.spin(forward, 90, percent); //intake
  rIntake.spin(forward, 90, percent);
  driveSystem.driveDistance(200, 600);
  driveSystem.turnDegrees(20, 300);
  driveSystem.driveDistance(200, 600, 0.5);
  driveSystem.scoreBall(6, 1); //score the ball

  //Go to 2nd tower
  driveSystem.driveDistance(-600, 600);
  driveSystem.turnDegrees(135, 300);
  driveSystem.driveDistance(750, 600, 2); //go to tower (already have ball)
  driveSystem.scoreBall(6, 1.5);
  driveSystem.turnOnlyLeftBack(90, 300);
  driveSystem.driveDistance(-1000, 600, 1.5);
}
