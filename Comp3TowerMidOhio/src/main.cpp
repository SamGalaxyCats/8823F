...
void autonomous(void) 
{
  ...
  driveSystem.turnDegrees(-40, 450);
  lIntake.spin(forward, intakeSpeed, rpm);
  rIntake.spin(forward, intakeSpeed, rpm);
  driveSystem.driveDistance(400, 600, 1.5); //go to tower
  lIntake.stop();
  rIntake.stop();
  ...
  //3rd tower
  driveSystem.turnDegrees(-200, 300); //turn 1
  driveSystem.driveDistance(1100, 700); //go
  driveSystem.turnDegrees(-186, 300); //dodge teammate
  driveSystem.driveDistance(1300, 600);
  driveSystem.turnDegrees(-135, 400); //face ball
  lIntake.spin(forward, intakeSpeed, rpm);
  rIntake.spin(forward, intakeSpeed, rpm);
  driveSystem.driveDistance(550, 400, 2);
  lIntake.stop();
  rIntake.stop();
  driveSystem.scoreBall(6, 2);
  lIntake.spin(forward, -intakeSpeed/2, rpm);
